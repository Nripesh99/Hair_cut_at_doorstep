        ...
        if ($process) {
            ...
            if (count($err) == 0) {
                ...
                //user type admin 
                    ...
                    $sql = "SELECT * FROM admin_register where email='$email' and password='$password' limit 1";
                    // echo "hello";
                    $aa = mysqli_query($connect, $sql);
                ...
                elseif ($usertype == 'Agent') {
                    include 'dbconfig.php';
                    $sqls = "SELECT * FROM agent_register where Email = '$email' and Password = '$password'Limit 1";
                    $aaa = mysqli_query($connect, $sqls);

                    if (mysqli_num_rows($aaa) == 1) {
